    		  ...
    		  <?php
    		    echo "<div>
                      ...
                      <div id='profile-img'>
                          ...
                          <form action='profile.php?u_id='$user_id' method='post' enctype='multipart/form-data'>
                              <label id='update_profile' class='btn btn-default'>Select Profile
                               <input type='file' name='u_image' size='60'/>
                              </label><br><br>
                               <button id='button-profile' name='update' class='btn btn-default'>Update Profile</button>
                          </form>
                      </div><br>
                     ";
               ?>
               <?php
                    ...
                    if(isset($_POST['submit'])){
                    	...
                    	if($u_cover ==''){
                    		...
                    		move_uploaded_file($image_tmp, "cover/$u _cover.$random_number");
                    ...
                    echo "
                       ...
                       if($u_email != $user_email){
                        echo "<script>window.open('profile.php?u_id=$user_id','_self')</script>";
                           ...
                           echo "<a href='single.php?post_id=$post_id' style='float:right;'><button style='color:#00cc00;'>View</button></a>
                             <a href='edit_post.php?post_id=$post_id' style='float:right;'><button style='color:#0000ff;'>Edit</button></a>
                             <a href='functions/delete_post.php?post_id=$post_id' style='float:right;'><button style='color:red;'>Delete</button></a>
                            </div><br><br><br>
                            ";
